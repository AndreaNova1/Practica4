...
<nav class="navbar navbar-expand-lg bg-dark text-white">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-link">
            <a  href=" {{ url('/Estudiantes') }}" class="btn btn-outline-btn bg-info text-white " type="submit">Tabla de Datos</a>
        </li>
        <li class="nav-link">
            <a  href=" {{ url('/Estudiantes/create') }}" class="btn btn-outline-btn bg-info text-white" type="submit">Creacion de Datos</a>
        </li>
    </div>
</nav>
